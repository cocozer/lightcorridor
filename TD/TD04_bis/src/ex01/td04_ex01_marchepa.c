...
int main(int argc, char** argv) 
{
	...
	unsigned char* monImage = stbi_load("doc/hotdog.jpg",&x,&y,&n,0);
		if(monImage== NULL){
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, &x, &y, 0, GL_RGB, GL_UNSIGNED_BYTE, stbi_load("doc/hotdog.jpg",&x,&y,&n,0)); //envoie les données vers le GPU
	glBindTexture(GL_TEXTURE_2D, 0); //permet de détacher la texture
